...
Este repositorio documenta el **apartado de Frontend**, desarrollado con **Angular** e **Ionic**, dentro del sistema integral de gestión para la Clínica Dental.  
...
| Tab11   | Inf Personal    | Registro de información personal del usuario.             | ✅
| Tabs    | Barra de tareas | Acceso rápido a las funciones principales.                | ✅
| Login   | Login           | Módulo de autenticación y acceso de usuarios.             | ✅

---

## 🚀 Tecnologías utilizadas (Frontend App)
- **Framework principal:** Angular  
- **Mobile/Hybrid UI:** Ionic  
- **Estilos:** TailwindCSS / Bootstrap  
- **Gestión de estado:** Servicios y RxJS  
- **Integraciones:** API REST para conexión con el backend  
