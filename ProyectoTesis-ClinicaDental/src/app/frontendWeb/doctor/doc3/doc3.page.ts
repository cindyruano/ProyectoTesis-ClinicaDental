...
@Component({
  selector: 'app-doc3',
  templateUrl: './doc3.page.html',
  styleUrls: ['./doc3.page.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule, RouterModule]
})
export class Doc3Page implements OnInit {
  ...
  nuevoExpediente() {
    this.router.navigate(['/admin/doc4']);
  }

  verExpediente(pacienteId: number) {
    this.router.navigate(['/admin/doc4', pacienteId]);
  }
}
